...
const Coaches = () => {
  ...
  const { coaches, loading, error, deleteCoach, updateCoachStatus } = useCoach();
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-600 font-medium">Loading coaches...</p>
        </div>
      </div>
    );
  }
  ...
  const inactiveCoaches = coaches.filter(coach => coach.status === 'inactive');
  ...
  const stats = [
    ...
    { 
      ...
      value: coaches.reduce((total, coach) => total + (coach.assignedBatches?.length || 0), 0).toString(), 
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className=" p-4 sm:p-6 transition-colors duration-300">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-3">
            <div>
              <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Coaching Team</h2>
              <p className="text-sm text-gray-600 mt-1">Manage your coaching staff and their assignments</p>
            </div>
            <div className="bg-purple-50 px-4 py-2 rounded-full border border-purple-100">
              <span className="text-sm font-semibold text-purple-700">{coaches.length} coaches</span>
            </div>
          </div>
          ...
          {coaches.length === 0 ? (
            <div className="text-center py-16 bg-gray-50 rounded-xl border-2 border-dashed border-gray-300">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-3">No coaches available</h3>
                ...
                >
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="max-w-[140px]">
                        <h3 className="font-bold text-gray-900 truncate">{coach.name}</h3>
                  ...
                  <div className="space-y-3 text-sm mb-4">
                    ...
                    <div>
                      ...
                      {coach.assignedBatches && coach.assignedBatches.length > 0 ? (
                  ...
                  <div className="mt-4 flex gap-2">
                    <button
                      onClick={() => navigate(`/admin/assign-batches/${coach._id}`)}
                    ...
                    <button
                      onClick={() => openStatusModal(coach._id, coach.status, coach.name)}
                      ...
                      } ${updatingId === coach._id ? 'opacity-50 cursor-not-allowed' : ''}`}
                    >
